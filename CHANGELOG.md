...
- Fix mod refresh reporting success but deleting nothing: game-owned mod files are removed via `reforger-rm-path` (sudo), and the UI counts cleared mods correctly
